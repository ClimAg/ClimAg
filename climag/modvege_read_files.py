...
def read_params(filename):
    ...
    -   sigma_gv: Rate of biomass loss with respiration for the green
        vegetative compartment (:math:`\\sigma_{GV}`) [0.4]
    -   sigma_gr: Rate of biomass loss with respiration for the green
        reproductive compartment (:math:`\\sigma_{GR}`) [0.2]
    ...
    -   h_grass: Minimum residual grass height after cutting; see sec.
        "Harvested biomass" in Jouven et al. [0.05 m]
    ...
    See Tables 2 and 3 in [#Jouven]_ for estimates of these
...
def read_timeseries(filename):
    ...
    -   PAR: Incident photosynthetically active radiation (:math:`PAR_i`)
        [MJ m⁻²]
